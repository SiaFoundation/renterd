...
var (
	...
	_ scannerValuer = (*NullableInt64)(nil)
...
// Scan scan value into NullableInt64, implements sql.Scanner interface.
func (i *NullableInt64) Scan(value interface{}) error {
	if value == nil {
		*i = 0
		return nil
	}
...
func (i NullableInt64) Value() (driver.Value, error) {
	if i == 0 {
		return nil, nil
	}
	return int64(i), nil
