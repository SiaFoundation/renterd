...
type (
	...
	MetadataStore interface {
		...
		UpdateObject(ctx context.Context, bucket, path, contractSet string, o object.Object, ETag string, usedContracts map[types.PublicKey]types.FileContractID) error
...
func (b *bus) objectsHandlerPUT(jc jape.Context) {
	...
	jc.Check("couldn't store object", b.ms.UpdateObject(jc.Request.Context(), aor.Bucket, jc.PathParam("path"), aor.ContractSet, aor.Object, aor.ETag, aor.UsedContracts))
}
