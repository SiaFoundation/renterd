...
func (c *Client) AddObject(ctx context.Context, bucket, path, contractSet string, o object.Object, ETag string, usedContract map[types.PublicKey]types.FileContractID) (err error) {
	path = strings.TrimPrefix(path, "/")
